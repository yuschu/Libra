...
# Add helper functions after the initGlobe function
old_end_initGlobe = """    }
    }
    ...
    function onGlobeClick(event) {
      ...
      if (intersects.length > 0) {
        ...
        const target = new THREE.Vector3(
          road.center_lon / 180 * Math.PI * 1.02,  // Convert lon to radians-ish
...
content = content.replace(old_animate, new_end_initGlobe)
