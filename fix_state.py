...
start = content.index('// ============ STATE ============')
end = content.index('// ============ UTILITIES ============', content.index('// ============ STATE ============'))
...
content = content[:content.index('// ============ STATE ============')] + new_state + content[content.index('// ============ UTILITIES ============'):]

with open('web-screen/dashboard.html', 'w', encoding='utf-8') as f:
    f.write(content)

print('Updated STATE section')
